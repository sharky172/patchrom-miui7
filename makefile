...
local-zip-file     := cm-11-20150110-UNOFFICIAL-noselinux-d855.zip

# The output zip file of MIUI rom, the default is porting_miui.zip if not specified
local-out-zip-file := MIUI_D855.zip
...
local-phone-apps := 
#Camera2 Bluetooth HTMLViewer KeyChain LatinIME NfcNci PacProcessor \
#        UserDictionaryProvider WAPPushManager

local-phone-priv-apps :=
# BackupRestoreConfirmation DefaultContainerService FusedLocation \
